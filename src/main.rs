...
fn main(){
    let article_handler=MyHandler::new(std::path::PathBuf::from("./sample_data/articles"), "./sample_data/template/article.html".into(), "./sample_data/template/dir.html".into(), "articles".into());

    let misc_handler=MyHandler::new(std::path::PathBuf::from("./sample_data/misc"), "./sample_data/template/misc.html".into(), "./sample_data/template/dir.html".into(), "misc".into());
